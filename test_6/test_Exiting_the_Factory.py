...
read_file_path = "./files/Exiting the Factory.flv"
dna_path = "./output/exiting_the_factory.dna"
model_path = "./output/exiting_the_factory.pkl"
write_file_path = "./output/output_exiting_the_factory.jpg"
